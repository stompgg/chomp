...
Many of these failures point to a mismatch between success for games and success for VCs. For an indie game, success can be anywhere from making $10k to $10m. How do you raise for something like that? Take $25k at a $500k valuation? Who is going to write that check? Historically crypto has had a massive liquidity premium, and last cycle's gaming entrants often had a large starting warchest in the millions thanks to NFT sales. This is literally setting you up for failure. You have now screened off all the moderately positive outcomes that the normal market could have welcomed by setting the starting valuation expectation too high.
...
And all of this is to speak nothing of the general base rates (most indie games fail) and the clientele (gamers are notoriously the second most entitled user group after airdrop farmers).

So you're doubly fucked.

Well, hopefully I've established above that you have to be kinda crazy to want to continue trying to make this work, and you need to figure out something sustainable. You cannot rely on venture or tokens to bail you out. You have to bail yourself out.

Hi, my name is Owen, and I'm an underwater ETH bagholder. (Everyone, please say hi back.)

I think the EVM is an incredibly rich programming environment, and I want to broaden everyone's horizons. DeFi has seen incredible adoption and resilience, and we're now seeing broader market structure like prediction markets or futarchy. There is definitely so much more out there to build, so many other apps. Crypto has grown up and the suits are here. A lot of the fun has gone, replaced by something sterile. I just want to build something for the four delusionally optimistic of us left. 

Yes, this is a niche within a niche within a niche. And I am happy if the best it does is spawn little side events at every ETH conference (if, pray tell, there will even be more conferences in the future). But I do think there is a space for something like Stomp. A game that everyone can play, or understand, or bet on.
