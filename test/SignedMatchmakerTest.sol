...
import {Battle, BattleData, BattleOffer, Mon, MonStats, Type} from "../src/Structs.sol";
...
contract SignedMatchmakerTest is Test, BattleHelper {
    ...
    */
    function test_invalidSignatureReverts() public {
        ...
        bytes32 structHash = BattleOfferLib.hashBattleOfferForSigning(offerForSigning, 0);
    ...
    */
    ...
    function test_openBattleOffer() public {
        ...
        vm.prank(p1);
        {
            bytes[4] memory seatSigs;
            seatSigs[0] = signature;
            matchmaker.startGame(offer, 4, seatSigs);
        }
    ...
    function test_openBattleSequentialNonceMultipleTakers() public {
        ...
        // p0 signs a new OPEN offer with nonce of 1
        offer.battle.p1 = address(0);
        offer.pairHashNonce = 1;
        signature = _signOpenOffer(offer);
