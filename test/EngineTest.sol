...
contract EngineTest is Test, BattleHelper {
    ...
    // Pack ForceSwitchMove extraData: bit 0 = playerIndex (0/1), bits 1..15 = monToSwitchIndex
    function _packForceSwitch(uint256 playerIndex, uint256 monToSwitchIndex) internal pure returns (uint16) {
        return uint16((playerIndex & 0x1) | (monToSwitchIndex << 1));
    }
    ...
    function setUp() public {
        ...
        dummyAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 0, ACCURACY: 0, STAMINA_COST: 0, PRIORITY: 0})
        );
    ...
    function test_fasterPriorityKOsGameOver() public {
        ...
        IMoveSet fastAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 10, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 1})
        );
    ...
    function _setup2v2FasterPriorityBattleAndForceSwitch() internal returns (bytes32) {
        ...
        bytes32 battleKey = _startBattle(twoMonValidator, engine, defaultOracle, defaultRegistry, matchmaker, address(commitManager));
    ...
    function test_nonKOSubsequentMoves() public {
        IMoveSet normalAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 0})
        );
        uint256[] memory moves = new uint256[](1);
        moves[0] = uint256(uint160(address(normalAttack)));
    ...
    function test_switchPriorityIsSlowerThanSuperfastMove() public {
        ...
        IMoveSet superFastAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 7})
        );
        uint256[] memory moves = new uint256[](1);
    ...
    function test_switchPriorityIsSlowerThanSuperfastMoveWithKO() public {
        ...
        IMoveSet superFastAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 10, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 7})
        );
        uint256[] memory moves = new uint256[](1);
        moves[0] = uint256(uint160(address(superFastAttack)));
        Mon memory normalMon = Mon({
    ...
    function test_defaultStaminaRegenEffect() public {
        ...
        bytes32 battleKey = _startBattle(
            twoMonValidator, engine, defaultOracle, defaultRegistry, matchmaker, new IEngineHook[](0), rules, address(commitManager)
        );
    ...
    function test_accuracyWorksAsExpectedWithRNG() public {
        ...
        IMoveSet inaccurateAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 1, STAMINA_COST: 1, PRIORITY: 0})
        );
    ...
    function test_invalidMoveIfStaminaCostTooHigh() public {
        ...
        IMoveSet highStaminaAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 100, STAMINA_COST: 2, PRIORITY: 0})
        );
    ...
    function test_effectAppliedByAttackCanKOForGameEnd() public {
        ...
        IMoveSet instantDeathAttack =
            new EffectAttack(instantDeath, EffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1}));
    ...
    function test_effectAppliedByAttackCorrectlyAppliesToTargetedMonEvenAfterSwitch() public {
        ...
        IMoveSet effectAttack =
            new EffectAttack(statBoost, EffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1}));
        ...
        bytes32 battleKey = _startBattle(oneMonValidator, engine, defaultOracle, defaultRegistry, matchmaker, address(commitManager));
    ...
    function test_moveKOAndEffectKOLeadToDualSwapOtherMoveRevertsForAlice() public {
        ...
        // Bob reveals a swap
        vm.startPrank(BOB);
        commitManager.revealMove(battleKey, SWITCH_MOVE_INDEX, salt, uint16(1), false);
    ...
    function test_shouldSkipTurnFlagWorks() public {
        ...
        IMoveSet normalAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 6})
        );
        uint256[] memory moves = new uint256[](1);
        moves[0] = uint256(uint160(address(normalAttack)));
        Mon memory normalMon = Mon({
        ...
        IMoveSet skipAttack =
            new SkipTurnMove(SkipTurnMove.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 7}));
    ...
    function test_forceSwitchMoveCorrectlySwitchesNonPriorityPlayerEndOfRound() public {
        ...
        IMoveSet switchAttack =
            new ForceSwitchMove(ForceSwitchMove.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 0}));
        ...
        IMoveSet normalAttack = new CustomAttack(
            typeCalc,
            CustomAttack.Args({TYPE: Type.Liquid, BASE_POWER: 5, ACCURACY: 100, STAMINA_COST: 1, PRIORITY: 1})
        );
        uint256[] memory moves = new uint256[](1);
        moves[0] = uint256(uint160(address(normalAttack)));
        Mon memory normalMon = Mon({
    ...
    function test_forceSwitchMoveCorrectlySwitchesPriorityPlayerAfterAttacking() public {
        ...
        IMoveSet switchAttack =
            new ForceSwitchMove(ForceSwitchMove.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 2}));
        uint256[] memory switchMoves = new uint256[](1);
        switchMoves[0] = uint256(uint160(address(switchAttack)));
        Mon memory switchMon = Mon({
            stats: MonStats({
    ...
    function test_effectOnSwitchInFromSwitchMoveKOsAndForcesSwitch() public {
        ...
        // Attack to force a switch for user (should be higher priority than the other move)
        IMoveSet switchAttack =
            new ForceSwitchMove(ForceSwitchMove.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1}));
        uint256[] memory switchMoves = new uint256[](1);
        switchMoves[0] = uint256(uint160(address(switchAttack)));
        Mon memory switchMon = Mon({
            stats: MonStats({
        ...
        IMoveSet instantDeathOnSwitchInAttack = new GlobalEffectAttack(
            instantDeathOnSwitchIn, GlobalEffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 2})
        );
        uint256[] memory moves = new uint256[](1);
    ...
    function test_effectOnSwitchInFromDirectSwitchMoveKOsAndForcesSwitch() public {
        ...
        IMoveSet instantDeathOnSwitchInAttack = new GlobalEffectAttack(
            instantDeathOnSwitchIn, GlobalEffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 10})
        );
    ...
    function test_attackThatAppliesEffectCanOnlyApplyOnce() public {
        ...
        IMoveSet effectAttack = new EffectAttack(
            singleInstanceEffect, EffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1})
        );
        uint256[] memory moves = new uint256[](1);
        moves[0] = uint256(uint160(address(effectAttack)));
        Mon memory mon = Mon({
    ...
    function test_onMonSwitchOutHookWorksWithTempStatBoost() public {
        ...
        // Create new effect attack that applies the temporary stat boost effect
        IMoveSet effectAttack = new EffectAttack(
            temporaryStatBoostEffect, EffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1})
        );
        moves[0] = uint256(uint160(address(effectAttack)));
        Mon memory mon = Mon({
            stats: MonStats({
    ...
    function test_afterDamageHookRuns() public {
        ...
        IMoveSet reboundAttack =
            new EffectAttack(reboundEffect, EffectAttack.Args({TYPE: Type.Liquid, STAMINA_COST: 1, PRIORITY: 1}));
    ...
    function test_cannotCommitToEndedBattle() public {
        ...
        bytes32 battleKey = _startBattle(noMoveValidator, engine, defaultOracle, defaultRegistry, matchmaker, address(commitManager));
    ...
    */
    function test_turn0DefaultCommitManagerInvalidPreimage() public {
        ...
        vm.startPrank(ALICE);
        vm.expectRevert(abi.encodeWithSignature("InvalidMove(address)", ALICE));
        uint16 invalidExtraData = uint16(0);
    ...
    function test_swapPlusDamageCorrectlySetsSwitchForTurnFlagAndSkipsKOMove() public {
        ...
        _commitRevealExecuteForAliceAndBob(battleKey, SWITCH_MOVE_INDEX, SWITCH_MOVE_INDEX, uint16(0), uint16(1));
        // Both players pick move index 0
        _commitRevealExecuteForAliceAndBob(battleKey, 0, 0, uint16(1), uint16(0));
