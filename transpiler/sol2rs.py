...
dependency knowledge) and emits a cargo workspace:
    ...
    transpiler/rs-output/
      ...
      strategies/         (hand-written crate, synced from transpiler/strategies-rs;
                           carries the standalone `arena` + `trace` bins)
...
[workspace]
resolver = "2"
members = ["engine", "runtime", "strategies"]
...
class SolidityToRustTranspiler:
    ...
    def _write_world_rs(self, engine_src: Path, symbols) -> None:
        ...
        lines = [
            '// Auto-generated by sol2rs — the World model: Env (block/msg context),',
            '// per-contract state structs, and the ExternalCalls harness seam.',
            'use chomp_rt as rt;',
    ...
    def _deploy_all_lines(self, symbols) -> List[str]:
        ...
        out = [
            '/// Every dispatchable contract name, in deploy_all registration order — the single',
            '/// source of truth for a harness address book + the arena\'s deployed-move set, so no',
            '/// hand-maintained copy can drift from the transpiled contract universe.',
    ...
    def _write_dispatch_rs(self, engine_src: Path, symbols) -> None:
        ...
        lines = [
            ...
            '// deploy_all registers ContractIds.',
            'use chomp_rt as rt;',
            'use chomp_rt::{U256, I256, B256, Address};',
    ...
    def _sync_crates(self) -> None:
        ...
        transpiler/runtime-rs, strategies-rs are the git-tracked
