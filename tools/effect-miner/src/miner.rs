use crate::create3::{compute_create3_address, extract_bitmap, matches_bitmap, Address, B256};
use rand::Rng;
use rayon::prelude::*;
...
pub fn mine_multiple(
    ...
    effects
        ...
        .map(|(name, bitmap)| {
            ...
            let result = mine_salt(createx_address, bitmap, Some(base_bytes), max_attempts_per_effect);
            (name, result)
        })
        .collect()
}
...
mod tests {
    use super::*;
    use crate::create3::parse_address;
